...
# Path to your folder
path = r"C:\Users\athar\OneDrive\Desktop\fulton_ring\fahe\education\virginia"
...
keep_virginia = keep_county[keep_county["state"] == "Virginia"]

# Get a set of Alabama county names for efficient lookup
virginia_counties = set(keep_virginia["county"])

# Keep only rows in df_out where 'County' is in that list
df_out12 = df_out[df_out["County"].isin(virginia_counties)]

# Save the final DataFrame to a CSV file
df_out12.to_csv("df_12.csv", index=False)