...
# Path to your folder
path = r"C:\Users\athar\OneDrive\Desktop\fulton_ring\fahe\education\northcarolina"
...
keep_northcarolina = keep_county[keep_county["state"] == "North Carolina"]

# Get a set of Alabama county names for efficient lookup
northcarolina_counties = set(keep_northcarolina["county"])

# Keep only rows in df_out where 'County' is in that list
df_out7 = df_out[df_out["County"].isin(northcarolina_counties)]

# Save the final DataFrame to a CSV file
df_out7.to_csv("df_7.csv", index=False)