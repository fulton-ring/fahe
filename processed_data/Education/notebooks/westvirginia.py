...
# Path to your folder
path = r"C:\Users\athar\OneDrive\Desktop\fulton_ring\fahe\education\westvirginia"
...
keep_westvirginia = keep_county[keep_county["state"] == "West Virginia"]

# Get a set of Alabama county names for efficient lookup
westvirginia_counties = set(keep_westvirginia["county"])

# Keep only rows in df_out where 'County' is in that list
df_out13 = df_out[df_out["County"].isin(westvirginia_counties)]

# Save the final DataFrame to a CSV file
df_out13.to_csv("df_13.csv", index=False)