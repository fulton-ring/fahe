...
# Path to your folder
path = r"C:\Users\athar\OneDrive\Desktop\fulton_ring\fahe\education\tennessee"
...
keep_tennessee = keep_county[keep_county["state"] == "Tennessee"]

# Get a set of Alabama county names for efficient lookup
tennessee_counties = set(keep_tennessee["county"])

# Keep only rows in df_out where 'County' is in that list
df_out11 = df_out[df_out["County"].isin(tennessee_counties)]

# Save the final DataFrame to a CSV file
df_out11.to_csv("df_11.csv", index=False)