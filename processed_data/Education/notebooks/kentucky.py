...
# Path to your folder
path = r"C:\Users\athar\OneDrive\Desktop\fulton_ring\fahe\education\kentucky"
...
keep_kentucky = keep_county[keep_county["state"] == "Kentucky"]

# Get a set of Alabama county names for efficient lookup
kentucky_counties = set(keep_kentucky["county"])

# Keep only rows in df_out where 'County' is in that list
df_out3 = df_out[df_out["County"].isin(kentucky_counties)]

# Save the final DataFrame to a CSV file
df_out3.to_csv("df_3.csv", index=False)